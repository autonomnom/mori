...
class Grozi extends Morikkel
{
		...
		if (G.lifeclock > G.maxlife) {
			...
			if (!amboden && oneplay == 0) {
				...
				if (!sitzt) {
					...
					gerani = "humi";
					grozi.callbackFunc = b4gammel1;
				}
			}
			else if (!amboden && oneplay == 1) {

				gerani = "wurmsis";
				grozi.callbackFunc = b4gammel2;
			}
	...
	private function b4gammel1() {

		gesang.play();
		oneplay = 1;
	}

	private function b4gammel2() {
	...
	private function spritesheet() {
		...
		//5
			...
			//END
			grozi.add("humi", [586, 586, 586, 586, 586, 586, 587, 587, 587, 587, 587, 587, 586, 586, 586, 586, 586, 586, 587, 587, 587, 587, 587, 587], 7, false);
			grozi.add("wurmsis", [620, 621, 622, 623, 624, 625, 626, 627, 628, 629, 630, 631, 632, 633, 634, 635, 636, 637, 638, 639, 640, 641, 642, 643, 644, 645, 646, 647, 648, 649, 650, 651, 652, 653, 654, 655, 656, 657, 658, 659, 660, 661, 662, 663, 664, 665, 666, 667, 668, 669, 670, 671, 672, 673, 674, 675, 676, 677, 678, 679, 680, 681, 682, 683, 684, 685, 686, 687, 688, 689, 690, 691, 692, 693, 694, 694, 694, 694, 694, 694, 694, 694, 694], 7, false);
			grozi.add("falll", [695, 696, 697, 698], 7, false);
