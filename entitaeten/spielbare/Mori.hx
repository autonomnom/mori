...
class Mori extends Morikkel
{
	...
	override public function update() {
		...
		if (G.lifeclock > G.maxlife) {
			...
			if (!amboden && oneplay == 0) {

				gerani = "wurms";
				mori.callbackFunc =	b4hingelegt1;
			}
			else if (!amboden && oneplay == 1) {

				gerani = "oper";
				mori.callbackFunc = b4hingelegt2;
			}
			else if (!amboden && oneplay == 2) {
	...
	private function b4hingelegt1() {

		gesang.play();
		oneplay = 1;
	}

	private function b4hingelegt2() {
	...
	private function spritesheet() {
		...
		mori.add("wurms", [818, 819, 820, 821, 822, 823, 824, 825, 826, 827, 754, 754, 754, 754, 754, 754, 754, 754, 754, 755, 755, 755, 755, 755, 755, 755, 755, 754, 754, 754, 754, 1006, 1006, 1006, 936, 936, 936, 936, 936, 936, 936, 936, 936, 936, 936, 936, 936, 936, 936, 936, 936], 7, false);
		mori.add("karotte", [1001, 1001, 1002, 1002, 1003, 1003, 1004, 1004, 1005, 1005], 1, false);
		mori.add("oper", [937, 938, 939, 940, 941, 942, 943, 944, 945, 946, 947, 948, 949, 950, 951, 952, 953, 954, 955, 956, 957, 958, 959, 960, 961, 962, 963, 964, 965, 966, 967, 968, 969, 970, 971, 972, 973, 974, 975, 976, 977, 978, 979, 980, 981, 982, 983, 984, 985, 986, 987, 988, 989, 990, 991, 992, 993, 994, 995, 995, 995, 995, 995, 995, 995, 995, 995, 995, 995, 995, 995], 7, false);
		mori.add("seufzer", [996, 997, 998, 999, 1000], 7, false);
	...
	public var morisschatten:Spritemap		= new Spritemap("graphics/enties/morischatten2.png", 34, 57);
}
