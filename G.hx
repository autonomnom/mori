...
class G
{
	...
	//lysopsch
	public static var lyready:Bool					= false; // WIRD GERADE FÜR IRGEND ETWAS ANDERES BENUTZT UND ICH HAB KEINE AHNUNG FÜR WAS // ANSCHEINEND DAMIT MAN WIEDER ZU MORI WERDEN KANN WEIL KEINE COLLISION DETECTION SONDERN RADIUS DETECTION BENUTZT WIRD
